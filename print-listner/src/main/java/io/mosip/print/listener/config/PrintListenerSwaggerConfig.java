package io.mosip.print.listener.config;
...
@Configuration
@EnableSwagger2
public class PrintListenerSwaggerConfig {

	private static final Logger LOGGER = LoggerFactory.getLogger(io.mosip.print.listener.config.PrintListenerSwaggerConfig.class);
