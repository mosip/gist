...
import io.mosip.partner.partnermanagement.model.restapi.PasswordRequest;
import io.mosip.partner.partnermanagement.exception.TokenGenerationFailedException;
...
public class RestApiClient {
	...
	public String getToken() throws IOException {
		...
		if (loginType.equals(LoginType.LOGIN_BY_USERID)) {
			apiUrl = environment.getProperty(ParameterConstant.AUTHENTICATION_API_URL.toString().toString());
