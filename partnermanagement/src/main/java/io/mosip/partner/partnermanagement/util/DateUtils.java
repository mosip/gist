 ...
 */
package io.mosip.partner.partnermanagement.util;
...
import io.mosip.partner.partnermanagement.constant.DateUtilConstants;
import io.mosip.partner.partnermanagement.exception.IllegalArgumentException;
...
public final class DateUtils {
	...
	public static LocalDateTime parseUTCToLocalDateTime(String utcDateTime, String pattern) {
		...
		try {
			...
			throw new io.mosip.partner.partnermanagement.exception.ParseException(
	...
	public static Date parseToDate(String dateString, String pattern) {
		if (Objects.isNull(dateString) || Objects.isNull(pattern)) {
			throw new io.mosip.partner.partnermanagement.exception.NullPointerException(
