package io.mosip.partner.partnermanagement.swagger;
...
public class PartnerManagementSwaggerConfig {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(io.mosip.partner.partnermanagement.swagger.PartnerManagementSwaggerConfig.class);
