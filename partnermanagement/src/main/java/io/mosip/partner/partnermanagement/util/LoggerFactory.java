...
public class LoggerFactory {
	...
	static {
		...
		MOSIP_ROLLING_APPENDER.setFileName("logs/partnerManager.log");
		MOSIP_ROLLING_APPENDER.setFileNamePattern("logs/partnerManager-%d{yyyy-MM-dd-HH}-%i.log");
		MOSIP_ROLLING_APPENDER.setMaxFileSize("5MB");
		MOSIP_ROLLING_APPENDER.setTotalCap("50MB");
		MOSIP_ROLLING_APPENDER.setMaxHistory(100);
