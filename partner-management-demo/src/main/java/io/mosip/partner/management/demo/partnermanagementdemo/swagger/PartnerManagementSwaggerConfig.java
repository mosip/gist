package io.mosip.partner.management.demo.partnermanagementdemo.swagger;
...
@Configuration
@EnableSwagger2
public class PartnerManagementSwaggerConfig {

	private static final Logger LOGGER = LoggerFactory.getLogger(io.mosip.partner.management.demo.partnermanagementdemo.swagger.PartnerManagementSwaggerConfig.class);
	...
	int port = -1;
	String hostWithPort = "localhost:9091";
